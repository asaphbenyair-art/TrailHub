        ...
        {!allowed ? (
          ...
          <>
            ...
            <div className="flex-1 overflow-y-auto p-3">
              ...
              {showForm && tab === "offers" && (
                <div className="border border-border rounded-xl p-3 mb-3 flex flex-col gap-2 bg-surface-2/60">
                  <div className="text-xs font-semibold text-fg">הצעת טרמפ חדשה</div>
                        ...
                        <div key={o.id} className={`rounded-xl p-3 border ${isPoster ? "border-accent bg-accent/10" : "border-border"}`}>
                          <div className="flex items-start gap-2.5">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              {/* Details row */}
                              <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-[11px] text-fg-muted mt-1.5">
                              ...
                              {o.note && <div className="text-[11px] text-fg-faint mt-1">{o.note}</div>}
                            </div>
                          </div>
                          ...
                          <div className="flex gap-2 mt-2.5">
                            {isPoster ? (
                              <button type="button" onClick={() => leave(o.id)}
                                className="flex-1 py-1.5 rounded-full text-xs font-medium text-[#C0392B] border border-[#C0392B]/30 hover:bg-surface-2">
                                בטל טרמפ
                              </button>
                            ) : iClaimed ? (
                              <button type="button" onClick={() => leave(o.id)}
                                className="py-1.5 px-3 rounded-full text-xs font-medium text-fg-muted border border-border">
                                עזוב מקום
                              </button>
                            ) : (
                            ...
                            <button type="button" onClick={() => openChat(o.posterId)}
                              className="flex-1 py-1.5 rounded-full text-xs font-medium text-fg bg-surface-2 hover:bg-surface-2 flex items-center justify-center gap-1.5">
